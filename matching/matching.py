...
class Matcher:
    ...
    def _close_match(self, ids: List[int]) -> Tuple[int, int]:
        ...
        try:
            ...
            print("ERROR: Insufficient matches") # PE: I suddenly got index error here when testing on new data, so I put in this try-except. Not sure why this worked before
            return 0, 0
